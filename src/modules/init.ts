...
const WINDOW_KEY = "__tournaments" as const;

type TournamentsInstance = InstanceType<typeof Tournaments>;

declare global {
  interface Window {
    [WINDOW_KEY]?: TournamentsInstance;
  }
}
 ...
 */
export function getTournaments(): TournamentsInstance {
