...
import setting from "../../modules/global-setting/global-setting.js";
...
export class PageConfig extends BaseElement {
  _setupProperties() {
    ...
    this._isDarkModeActive = new Signal(this.globalSetting.isDarkThemeActive());
    this._cacheCleared = new Signal(false);
